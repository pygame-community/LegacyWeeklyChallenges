...
class Particles(Object):
    def __init__(self, pos, vel,
        ...
        if self.size_change < 0:
            max_calculated_lifetime = int((self.particles_size+self.size_change)/-self.size_change)
    ...
    def add_particle(self):
        ...
        if self.free_particles:
            ...
            self.particles_r[free_index] = self.particles_size+((random()-0.5)*self.size_variance)
