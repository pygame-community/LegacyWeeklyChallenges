...
fog_size = 35
fogs = [pygame.Surface((fog_size, fog_size), pygame.SRCALPHA), pygame.Surface((1024, 768), pygame.SRCALPHA)]
...
def draw_light(radius, quality):
	...
	for i in range(loop_count):
		pygame.draw.circle(surface, (20, 20, 20, 220-i*color_change), (radius, radius), radius-i*2)
	return(surface)
