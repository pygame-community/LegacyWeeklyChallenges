...
class Button:
    def __init__(self, text, colour, darker_colour, rect, icon, is_double_click,  border_thickness = 2, text_colour = (0,0,0),  border_colour = (0,0,0), button_x = 120, button_y = 35, confirm_txt = "Are you sure?"):
        #Button properties
    ...
    def update(self, screen: pygame.Surface):
        ...
        #Setting the button colour to normal if the cursor isn't over the button
            ...
            screen.blit(self.icon,(self.inside.right - self.button_x, self.inside.y + self.button_y))
